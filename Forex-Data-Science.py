...
from keras.layers.cone import Dense, Dropout, Activation, Input, LSTM, Dense
...
# We will use only few attribute to build our first classification model for
# FASTBIZ coupon enabling on estimation of accuracy of data submitted by
# customers.
